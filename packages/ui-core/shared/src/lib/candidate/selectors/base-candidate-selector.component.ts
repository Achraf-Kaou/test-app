...
import { CandidateStatusEnum, ICandidate, IPagination } from '@packages/contracts';
import { distinctUntilChange } from '@packages/ui-core/common';
import { CandidatesService, ErrorHandlingService, Store } from '@packages/ui-core/core';
