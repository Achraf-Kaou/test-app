...
import { ID, IEmployee, IOrganizationProjectModule, IOrganizationProjectModuleEmployee } from '@packages/contracts';
import { OrganizationProjectModuleService, ToastrService } from '@packages/ui-core/core';
