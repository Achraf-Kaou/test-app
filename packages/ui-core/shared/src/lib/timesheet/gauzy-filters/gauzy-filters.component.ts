...
import { ITimeLogFilters, PermissionsEnum, TimeFormatEnum, TimeLogSourceEnum, TimeLogType } from '@packages/contracts';
import { TranslationBaseComponent } from '@packages/ui-core/i18n';
import { ActivityLevel, TimesheetFilterService } from '@packages/ui-core/core';
