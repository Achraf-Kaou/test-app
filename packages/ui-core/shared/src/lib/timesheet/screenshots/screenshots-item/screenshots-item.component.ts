...
import { ITimeSlot, IScreenshot, ITimeLog, IOrganization, IEmployee, TimeFormatEnum } from '@packages/contracts';
import { DEFAULT_SVG, distinctUntilChange, isNotEmpty, progressStatus } from '@packages/ui-core/common';
import { ErrorHandlingService, Store, TimesheetService, ToastrService } from '@packages/ui-core/core';
