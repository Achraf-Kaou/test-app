...
import { WeekDaysEnum } from '@packages/contracts';
import { TranslateModule } from '@ngx-translate/core';
import { EmployeeStore, EmployeesService, OrganizationEditStore, OrganizationsService } from '@packages/ui-core/core';
