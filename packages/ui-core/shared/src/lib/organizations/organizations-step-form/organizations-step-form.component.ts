...
import { DEFAULT_DATE_FORMATS } from '@packages/constants';
import {
	BonusTypeEnum,
	ICountry,
...
import { environment as ENV } from '@packages/ui-config';
import { DUMMY_PROFILE_IMAGE, retrieveNameFromEmail } from '@packages/ui-core/common';
import { Store, ToastrService } from '@packages/ui-core/core';
...
export class OrganizationsStepFormComponent implements OnInit, OnDestroy, AfterViewInit {
	...
	@ViewChild('leafletTemplate') leafletTemplate: LeafletMapComponent;
