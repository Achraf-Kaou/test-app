...
import {
	...
	RoleService
} from '@packages/ui-core/core';
import { ThemeModule, ThemeSelectorModule } from '@packages/ui-core/theme';
import { NgxFaqModule, PasswordFormFieldModule, SharedModule, getBrowserLanguage } from '@packages/ui-core/shared';
import { HttpLoaderFactory } from '@packages/ui-core/i18n';
